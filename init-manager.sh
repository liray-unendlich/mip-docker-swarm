...
set -o allexport; source .env; PORTAINER_CLIENT_SECRET="\"\$plaintext\$"${CLIENT_SECRET}\"; set +o allexport; envsubst < ./authelia/configuration.tmpl.yml > data/authelia/config/configuration.yml
